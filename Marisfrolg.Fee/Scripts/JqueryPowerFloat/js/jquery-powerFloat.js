 ...
 * http://www.zhangxinxu.com/study/201012/jquery-power-float-demo.html## （陆帅华修改:isImage)
 * © by zhangxinxu  
...
(function($) {
	...
	var defaults  = {
		...
		targetMode: "common", //浮动层的类型，其他可选参数有：ajax, list, remind, isImage(仅仅拉取图片)
